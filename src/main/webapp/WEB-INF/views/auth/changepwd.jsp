  ...
  <nav class="navbar navbar-expand-md navbar-dark bg-dark mb-4">
    <div class="container-fluid">
      ...
      <div id="navbarCollapse" class="collapse navbar-collapse">
        ...
        <ul class="navbar-nav">
          <t:ifUnauth module="admin">
            <li class="nav-item"><t:actionLink action="login" controller="auth" labelKey="nav.login" clazz="nav-link" /></li>
          </t:ifUnauth>

          <t:ifAuth module="admin">
            <li class="nav-item dropdown"><a href="#" id="authDrp" data-bs-toggle="dropdown" aria-expanded="false" class="nav-link dropdown-toggle"> <t:userName module="admin" /></a>
  ...
  <main>
    <div class="container bg-white shadow rounded my-4">
      <div class="row text-center py-5">
        <h1 class="fs-3 mb-0">${fn:res(ctx, "page.change_password")}</h1>
      </div>
