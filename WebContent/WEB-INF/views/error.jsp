...
<title>${fn:res(ctx, "error_page.page_title")}</title>
  ...
  <main role="main">
    <div class="container bg-white shadow rounded my-4">
      <div class="row text-center py-5">
        <h1 class="fs-3 mb-0" style="text-transform: uppercase;">${fn:res(ctx, "error_page.page_title")}</h1>
      </div>
